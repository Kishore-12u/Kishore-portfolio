...
<head>
    ...
    <title>Kishore T - Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <header>
        ...
        <img src="/IMG_20250128_174935_421" alt="Kishore T" class="profile-picture">
    ...
    <section id="resume">
        ...
        </div>/storage/emulated/0/Download/Resume (1).pdf
    </section>

    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="Kishorr T">cs2301111058225@lngovernmentcollege.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 Kishore T. All Rights Reserved.</p>
    </footer>
</body>
</html>
